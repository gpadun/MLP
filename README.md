Este repositório contém a implementação do zero de uma rede neural **Multilayer Perceptron (MLP)** desenvolvida para a classificação de caracteres de matrizes de pixels.
